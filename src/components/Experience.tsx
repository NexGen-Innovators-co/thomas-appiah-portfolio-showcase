...
const Experience = () => {
  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-slate-800/30 via-slate-900/60 to-slate-800/30"></div>
      ...
      <div className="absolute right-8 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-teal-500/30 to-transparent"></div>
      
      {/* Timeline Nodes */}
      <div className="absolute left-6 top-1/4 w-4 h-4 bg-blue-500/40 rounded-full animate-pulse"></div>
      <div className="absolute left-6 top-2/4 w-4 h-4 bg-teal-500/40 rounded-full animate-pulse delay-1000"></div>
      <div className="absolute left-6 top-3/4 w-4 h-4 bg-blue-400/40 rounded-full animate-pulse delay-2000"></div>
      
      <div className="absolute right-6 top-1/3 w-4 h-4 bg-teal-500/40 rounded-full animate-pulse delay-500"></div>
      <div className="absolute right-6 top-2/3 w-4 h-4 bg-blue-500/40 rounded-full animate-pulse delay-1500"></div>
      
      {/* Connecting Lines */}
      <div className="absolute top-1/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/20 to-transparent"></div>
      <div className="absolute top-3/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-teal-500/20 to-transparent"></div>
      
      {/* Achievement Highlights */}
      <div className="absolute top-20 right-20 text-yellow-500/30 animate-pulse">
